    ...
    <tbody>
        <tr>
            <td style="text-align: center;">
                <p>
                    <a style="margin-left: auto; margin-right: auto;" imageanchor="1" href="/img/planes-trains-automobiles.jpg">
                        <img width="320" height="198" border="0" src="/img/planes-trains-automobiles.jpg">
                    </a>
                </p>
            </td>
        </tr>
...
<table class="tr-caption-container" cellspacing="0" cellpadding="0" style="float: right; text-align: center;">
    <tbody>
        <tr>
            <td style="text-align: center;">
                <p>
                    <a style="margin-left: auto; margin-right: auto;" imageanchor="1" href="/img/terminal-tom-hanks.jpg">
                        <img width="320" height="207" border="0" src="/img/terminal-tom-hanks.jpg">
                    </a>
                </p>
            </td>
        </tr>
...
<table class="tr-caption-container" cellspacing="0" cellpadding="0" style="float: left; text-align: center;">
    <tbody>
        <tr>
            <td style="text-align: center;">
                <p>
                    <a style="margin-left: auto; margin-right: auto;" imageanchor="1" href="/img/airplane7.jpg">
                        <img width="320" height="181" border="0" src="/img/airplane7.jpg">
                    </a>
                </p>
            </td>
        </tr>
...
<table class="tr-caption-container" cellspacing="0" cellpadding="0" style="float: right; margin-left: 1em; text-align: right;">
    <tbody>
        <tr>
            <td style="text-align: center;">
                <p>
                    <a style="clear: right; margin-bottom: 1em; margin-left: auto; margin-right: auto;" imageanchor="1" href="/img/airplane.jpg">
                        <img border="0" src="/img/airplane.jpg">
                    </a>
                </p>
            </td>
        </tr>
...
<table class="tr-caption-container" cellspacing="0" cellpadding="0" style="float: right; text-align: center;">
    <tbody>
        <tr>
            <td style="text-align: center;">
                <p>
                    <a style="margin-left: auto; margin-right: auto;" imageanchor="1" href="/img/dontgo.png">
                        <img width="320" height="179" border="0" src="/img/dontgo.png">
                    </a>
                </p>
            </td>
        </tr>
...
<table class="tr-caption-container" cellspacing="0" cellpadding="0" style="float: left; margin-right: 1em; text-align: left;">
    <tbody>
        <tr>
            <td style="text-align: center;">
                <p>
                    <a style="clear: left; margin-bottom: 1em; margin-left: auto; margin-right: auto;" imageanchor="1" href="/img/partybus.jpg">
                        <img width="320" height="240" border="0" src="/img/partybus.jpg">
                    </a>
                </p>
            </td>
        </tr>
...
<p class="separator" style="clear: both; text-align: center;">
    <a style="margin-left: 1em; margin-right: 1em;" imageanchor="1" href="/img/united.png">
        <img width="303" height="320" border="0" src="/img/united.png">
    </a>
</p>
<p>
    <br>
