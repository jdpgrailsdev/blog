...
In a http://www.jonathanpearlin.com/2014/09/30/spring_boot_jetty_jmx.html[previous post, window="_blank"], I discussed how to use {jetty} as the servlet container in a {spring_boot} application over the default implementation
