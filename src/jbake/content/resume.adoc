...
==== Gradle - Remote (Massachusetts) ====
===== Principal Software Engineer =====
January 2026 - Present

* Championed the use of observability to improve application performance
* Helped with transition to a more agile, value stream focused development lifecycle
* Collaborated closely with team lead to help drive technical proposals and
implementations
* Designed and implemented features that improved Gradle’s remote cache offering
...
* https://www.github.com/airbytehq[Airbyte, window="_blank"]
