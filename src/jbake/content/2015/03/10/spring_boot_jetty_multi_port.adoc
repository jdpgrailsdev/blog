...
http://jdpgrailsdev.github.io/blog/2014/10/07/spring_boot_jetty_thread_pool.html[previous post, window="_blank"], I showed how to customize the embedded {jetty} server in order to
